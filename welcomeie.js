...
function assegna()
{
  ...
  if(azienda.style.backgroundColor=="" || azienda.style.backgroundColor=="grey")
  ...
  if(f==0)
  {
   ...
   document.register.user.style.backgroundColor="#5679B6";
    ...
    label2.setAttribute("class","etichetteright");
	  ...
	  label2.innerText="Indirizzo e-mail";
    ...
    label5.setAttribute("id","etichettadata");
	  ...
	  label5.innerText="Data di Nascita";
	  ...
	  while (rimuovi.firstChild)
    {
	 ...
	 label.innerText="Ragione Sociale";
	 var input=document.createElement("input");
	 input.setAttribute("type","text");
	 input.setAttribute("class","campiright");
   ...
   label3.setAttribute("class","etichetteright");
	 ...
	 label3.innerText="Indirizzo e-mail";
	 var input3=document.createElement("input");
...
function improvereg()
{
 ...
 if(document.login.username.style.backgroundColor!="")
 document.login.username.style.backgroundColor="";


 if(document.login.psw.style.backgroundColor!="")
 document.login.psw.style.backgroundColor="";
